...
session_exercise = db.Table('session_exercise',
...
class Workout(BaseModel, db.Model):
    ...
    exercises = db.relationship('Exercise',secondary=workout_exercise, back_populates='workout')
...
class Session(BaseModel, db.Model):
    ...
    exercises = db.relationship('Exercise',secondary=session_exercise, back_populates='sessions')
