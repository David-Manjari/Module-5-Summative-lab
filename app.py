...
def get_workouts():
    ...
    # ?page=1&per_page=10  (both optional, with sane defaults)
...
def update_workout(workout_id):
    ...
    # Authorization check: authenticated, but is this THEIR workout?
    ...
    try:
        # partial=True allows updating just one or two fields at a time
